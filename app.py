...
<div style='text-align: center; background: linear-gradient(135deg, #004e92 0%, #000428 100%); padding: 20px; border-radius: 10px; color: white; margin-bottom: 20px;'>
    ...
    <p style='margin-top:10px;'>Tác giả: Cô Hoàng Thị Loan - PTDTBT TH Du Tiến </p>
</div>
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Hoàn Thị Loan - Trường PTDTBT Tiểu học Du Tiến - ĐT: 0363915655 </div>", unsafe_allow_html=True)
